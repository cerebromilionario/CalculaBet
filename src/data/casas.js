...
export const casas = [
  ...
  },
  {
    ...
    nome: 'PARIPESA',
    initials: 'PP',
    logo: { src: '/logos/partners/paripesa-logo.svg', alt: 'Logo PARIPESA' },
    category: 'Apostas esportivas e cassino online',
    description: 'Casa de apostas e jogos online com campanhas promocionais para usuários.',
    desc: 'Casa de apostas e jogos online com campanhas promocionais para usuários.',
    bonus: 'Campanhas promocionais para usuários conforme termos da plataforma',
    cta: 'Abrir conta',
    affiliateUrl: 'https://track.afiliapub.com/click?o=37&a=550220524&link_id=551',
    link: 'https://track.afiliapub.com/click?o=37&a=550220524&link_id=551',
    disclaimer: defaultDisclaimer,
    cor: '#2563eb',
    licencaInfo: 'Verifique licença, termos e disponibilidade diretamente na plataforma.',
    destaque: 'Parceiro aprovado',
  ...
  },
  {
    ...
    bonus: 'Campanhas promocionais para usuários conforme termos da plataforma',
    cta: 'Abrir conta',
    affiliateUrl: 'https://track.afiliapub.com/click?o=79&a=550220524&link_id=725',
    link: 'https://track.afiliapub.com/click?o=79&a=550220524&link_id=725',
    disclaimer: defaultDisclaimer,
    cor: '#6366f1',
    licencaInfo: 'Verifique licença, termos e disponibilidade diretamente na plataforma.',
    destaque: 'Parceiro aprovado',
