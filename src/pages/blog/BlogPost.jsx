...
import OddsJustasArticle from './articles/OddsJustasArticle';
...
import SurebetECrimeArticle from './articles/SurebetECrimeArticle';
...
function getFaqsForPost(slug) {
  return {
    ...
    'surebet-e-crime': SUREBET_E_CRIME_FAQS,
  }[slug] || [];
}
    ...
    <>
      ...
      <main className="relative overflow-hidden pt-28 pb-20">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {post.slug === 'value-bet-o-que-e' ? (
            <ValueBetArticle post={post} category={category} relatedPosts={relatedPosts} />
          ) : post.slug === 'apostas-esportivas-para-iniciantes' ? (
            <BeginnerGuideArticle post={post} category={category} relatedPosts={relatedPosts} />
          ) : post.slug === 'odds-decimais-americanas-fracionarias' ? (
          ...
          ) : post.slug === 'odds-justas' ? (
            <OddsJustasArticle post={post} category={category} relatedPosts={relatedPosts} />
          ) : post.slug === 'o-que-e-unidade-apostas' ? (
            <UnidadeStakeArticle post={post} category={category} relatedPosts={relatedPosts} />
          ) : post.slug === 'rollover-apostas' ? (
          ...
          ) : post.slug === 'surebet-e-crime' ? (
            <SurebetECrimeArticle post={post} category={category} relatedPosts={relatedPosts} />
          ) : (
          <>
